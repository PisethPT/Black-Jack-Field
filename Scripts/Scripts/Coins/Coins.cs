...
public class Coins : MonoBehaviour
{
    ...
    [SerializeField]  public Text txtCoins, texts;
    ...
    public void getCoinSuffer()
    {
        ...
        else if(FindAnyObjectByType<GameManager>().money >= coinSuffer && i < coinsActive.Length​​)
        {
            ...
            bets = FindAnyObjectByType<GameManager>().bets;
            bets *= 1000;
            FindAnyObjectByType<GameManager>().coinDisplay += coinSuffer;
            FindAnyObjectByType<PlayerCoin_Suffer>().convertNumber(bets, txtCoins);
            texts.text = FindAnyObjectByType<GameManager>().bets.ToString() + " k";
